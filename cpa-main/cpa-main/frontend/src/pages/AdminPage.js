        ...
        <div style={{ minHeight: '100vh', background: '#f4f6f8' }}>
            ...
            <div style={{ maxWidth: 900, margin: '0 auto', padding: '32px 24px 48px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16, marginBottom: 28, paddingBottom: 20, borderBottom: '1px solid #e2e8f0' }}>
                    <div>
                        <h1 style={{ fontSize: 26, fontWeight: 700, color: '#1a202c', margin: '0 0 3px' }}>Administradores</h1>
                        <p style={{ fontSize: 13, color: '#718096', margin: 0 }}>Gerencie os usuários com acesso administrativo</p>
                    </div>
                    <button
                ...
                <div style={{ marginBottom: 20 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: '#fff', border: '1.5px solid #e2e8f0', borderRadius: 10, padding: '10px 16px', maxWidth: 420, boxShadow: '0 1px 3px rgba(0,0,0,0.06)', transition: 'border-color 150ms, box-shadow 150ms' }}
                    ...
                    >
                        ...
                        <input type="text" value={searchQuery} onChange={e => setSearchQuery(e.target.value)} placeholder="Pesquisar administradores..."
                ...
                <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: 14, boxShadow: '0 2px 8px rgba(0,0,0,0.07)', overflow: 'hidden', animation: 'fadeInUp 400ms 150ms both' }}>
                    <TableAdmins updateTable={updateTable} searchQuery={searchQuery} onSuccess={handleSuccess} />
                </div>
            </div>

            <ModalAdmin show={modalShow} onHide={() => setModalShow(false)} onSuccess={handleSuccess} />
        </div>
    );
};
