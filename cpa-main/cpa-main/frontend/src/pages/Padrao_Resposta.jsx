        ...
        <>
            ...
            <div style={{ maxWidth: 1200 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16, marginBottom: 28, paddingBottom: 20, borderBottom: '1px solid #e2e8f0' }}>
                    <div>
                        <h1 style={{ fontSize: 26, fontWeight: 700, color: '#1a202c', margin: '0 0 3px' }}>Padrões de Resposta</h1>
                        <p style={{ fontSize: 13, color: '#718096', margin: 0 }}>Gerencie os padrões de resposta e suas alternativas</p>
                    </div>
                    <button
